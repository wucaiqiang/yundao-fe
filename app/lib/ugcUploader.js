        ...
        r = d.BufferedBlockAlgorithm = k.extend({
            ...
            _process: function (a) {
                var c = this._data,
                    ...
                    e = a
                        ? g.ceil(e)
                        : g.max((0 | e) - this._minBufferSize, 0);
...
function (global, factory) {
    ...
    function internalData(elem, name, data, pvt) {
        if (jQuery.acceptData(elem)) {
            ...
            if (id && cache[id] && (pvt || cache[id].data) || void 0 !== data || "string" != typeof name) 
                return id || (id = isNode
                    ? elem[internalKey] = deletedIds.pop() || jQuery.guid ++: internalKey),
                cache[id] || (cache[id] = isNode
                    ? {}
                    : {
                        toJSON: jQuery.noop
                    }),
                "object" != typeof name && "function" != typeof name || (pvt
                ...
                "string" == typeof name
                    ? null == (ret = thisCache[name]) && (ret = thisCache[jQuery.camelCase(name)])
                    : ret = thisCache,
                ret
        }
    }
        ...
        if (jQuery.isArray(obj)) 
            jQuery.each(obj, function (i, v) {
                traditional || rbracket.test(prefix)
                    ? add(prefix, v)
                    : buildParams(prefix + "[" + ("object" == typeof v
                        ? i
                        : "") + "]", v, traditional, add)
            });
    ...
    var deletedIds = [],
        ...
        support = {},
        version = "1.11.1 -css,-css/addGetHookIf,-css/curCSS,-css/defaultDisplay,-css/hiddenVisible" +
                "Selectors,-css/support,-css/swap,-css/var/cssExpand,-css/var/isHidden,-css/var/r" +
                "margin,-css/var/rnumnonpx,-effects,-effects/Tween,-effects/animatedSelector,-eff" +
                "ects/support,-dimensions,-offset,-deprecated,-event-alias,-wrap",
        ...
        for ("boolean" == typeof target && (deep = target, target = arguments[i] || {}, i++), "object" == typeof target || jQuery.isFunction(target) || (target = {}), i === length && (target = this, i--); i < length; i++) 
            if (null != (options = arguments[i])) 
                for (name in options) 
                    src = target[name],
                    copy = options[name],
                    target !== copy && (deep && copy && (jQuery.isPlainObject(copy) || (copyIsArray = jQuery.isArray(copy)))
                        ? (copyIsArray
                            ? (copyIsArray = !1, clone = src && jQuery.isArray(src)
                                ? src
                                : [])
    ...
    jQuery.extend({
        ...
        makeArray: function (arr, results) {
            var ret = results || [];
            return null != arr && (isArraylike(Object(arr))
                ? jQuery.merge(ret, "string" == typeof arr
                    ? [arr]
                    : arr)
                : push.call(ret, arr)),
            ret
        ...
        if ("string" == typeof selector) {
            ...
            if (match[1]) {
                if (context = context instanceof jQuery
                    ? context[0]
                    : context, jQuery.merge(this, jQuery.parseHTML(match[1], context && context.nodeType
                    ? context.ownerDocument || context
                    : document, !0)), rsingleTag.test(match[1]) && jQuery.isPlainObject(context)) 
        ...
        var firing,
            ...
            self = {
                ...
                fireWith: function (context, args) {
                    return !list || fired && !stack || (args = args || [], args = [
                        context, args.slice
                            ? args.slice()
                            : args
                    ], firing
    ...
    jQuery.extend({
        Deferred: function (func) {
            ...
            jQuery.each(tuples, function (i, tuple) {
                ...
                deferred[tuple[0]] = function () {
                    return deferred[tuple[0] + "With"](this === deferred
                        ? promise
                        : this, arguments),
                    this
                },
        ...
        when: function (subordinate) {
            var progressValues,
                ...
                remaining = 1 !== length || subordinate && jQuery.isFunction(subordinate.promise)
                    ? length
                    : 0,
            ...
            if (length > 1) 
                for (progressValues = new Array(length), progressContexts = new Array(length), resolveContexts = new Array(length); i < length; i++) 
    ...
    jQuery.extend({
        ...
        holdReady: function (hold) {
            hold
                ? jQuery.readyWait ++: jQuery.ready(!0)
        },
        ready: function (wait) {
            if (!0 === wait
                ? !--jQuery.readyWait
    ...
    jQuery.extend({
        queue: function (elem, type, data) {
            ...
            if (elem) 
                ...
                data && (!queue || jQuery.isArray(data)
        ...
        .extend({
            ...
            promise: function (type, obj) {
                ...
                for ("string" != typeof type && (obj = type, type = void 0), type = type || "fx"; i--;) 
                    (tmp = jQuery._data(elements[i], type + "queueHooks")) && tmp.empty && (count++, tmp.empty.add(resolve));
                return resolve(),
                defer.promise(obj)
            }
        }),
    jQuery.event = {
        ...
        add: function (elem, types, handler, data, selector) {
            ...
            if (elemData) {
                for (handler.handler && (handleObjIn = handler, handler = handleObjIn.handler, selector = handleObjIn.selector), handler.guid || (handler.guid = jQuery.guid++), (events = elemData.events) || (events = elemData.events = {}), (eventHandle = elemData.handle) || (eventHandle = elemData.handle = function (e) {
                    return void 0 === jQuery || e && jQuery.event.triggered === e.type
                        ? void 0
                        : jQuery
                            .event
                            .dispatch
                ...
                eventHandle.elem = elem), types = (types || "").match(rnotwhite) || [""], t = types.length; t--;) 
                    ...
                    type && (special = jQuery.event.special[type] || {}, type = (selector
                    ...
                    }, handleObjIn), (handlers = events[type]) || (handlers = events[type] = [], handlers.delegateCount = 0, special.setup && !1 !== special.setup.call(elem, data, namespaces, eventHandle) || (elem.addEventListener
                        ? elem.addEventListener(type, eventHandle, !1)
                        : elem.attachEvent && elem.attachEvent("on" + type, eventHandle))), special.add && (special.add.call(elem, handleObj), handleObj.handler.guid || (handleObj.handler.guid = handler.guid)), selector
            ...
            if (elemData && (events = elemData.events)) {
                for (types = (types || "").match(rnotwhite) || [""], t = types.length; t--;) 
                    if (tmp = rtypenamespace.exec(types[t]) || [], type = origType = tmp[1], namespaces = (tmp[2] || "").split(".").sort(), type) {
                        for (special = jQuery.event.special[type] || {}, type = (selector
                            ? special.delegateType
                            : special.bindType) || type, handlers = events[type] || [], tmp = tmp[2] && new RegExp("(^|\\.)" + namespaces.join("\\.(?:.*\\.|)") + "(\\.|$)"), origCount = j = handlers.length; j--;) 
            ...
            var handle,
                ...
                namespaces = hasOwn.call(event, "namespace")
                    ? event
                        ...
                        .split(".")
                    : [];
            if (cur = tmp = elem = elem || document, 3 !== elem.nodeType && 8 !== elem.nodeType && !rfocusMorph.test(type + jQuery.event.triggered) && (type.indexOf(".") >= 0 && (namespaces = type.split("."), type = namespaces.shift(), namespaces.sort()), ontype = type.indexOf(":") < 0 && "on" + type, event = event[jQuery.expando]
                ? event
                : new jQuery.Event(type, "object" == typeof event && event), event.isTrigger = onlyHandlers
                ? 2
                : 3, event.namespace = namespaces.join("."), event.namespace_re = event.namespace
                ? new RegExp("(^|\\.)" + namespaces.join("\\.(?:.*\\.|)") + "(\\.|$)")
                : null, event.result = void 0, event.target || (event.target = elem), data = null == data
                ? [event]
                : jQuery.makeArray(data, [event]), special = jQuery.event.special[type] || {}, onlyHandlers || !special.trigger || !1 !== special.trigger.apply(elem, data))) {
            ...
            if (args[0] = event, event.delegateTarget = this, !special.preDispatch || !1 !== special.preDispatch.call(this, event)) {
                for (handlerQueue = jQuery.event.handlers.call(this, event, handlers), i = 0; (matched = handlerQueue[i++]) && !event.isPropagationStopped();) 
                    for (event.currentTarget = matched.elem, j = 0; (handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped();) 
                        event.namespace_re && !event.namespace_re.test(handleObj.namespace) || (event.handleObj = handleObj, event.data = handleObj.data, void 0 !== (ret = ((jQuery.event.special[handleObj.origType] || {}).handle || handleObj.handler).apply(matched.elem, args)) && !1 === (event.result = ret) && (event.preventDefault(), event.stopPropagation()));
            return special.postDispatch && special
                    .postDispatch
                    .call(this, event),
                event.result
            }
                ...
                for (; cur != this; cur = cur.parentNode || this) 
                    if (1 === cur.nodeType && (!0 !== cur.disabled || "click" !== event.type)) {
                        for (matches = [], i = 0; i < delegateCount; i++) 
                            ...
                            void 0 === matches[sel] && (matches[sel] = handleObj.needsContext
        ...
        fix: function (event) {
            ...
            for (fixHook || (this.fixHooks[type] = fixHook = rmouseEvent.test(type)
                ? this.mouseHooks
                : rkeyEvent.test(type)
                    ? this.keyHooks
                    : {}), copy = fixHook.props
                ? this.props.concat(fixHook.props)
                : this.props, event = new jQuery.Event(originalEvent), i = copy.length; i--;) 
                prop = copy[i],
        ...
        keyHooks: {
            ...
            filter: function (event, original) {
                return null == event.which && (event.which = null != original.charCode
                    ? original.charCode
                    : original.keyCode),
                event
            }
        ...
        mouseHooks: {
            ...
            filter: function (event, original) {
                ...
                !event.relatedTarget && fromElement && (event.relatedTarget = fromElement === event.target
                    ? original.toElement
                    : fromElement),
                event.which || void 0 === button || (event.which = 1 & button
                    ? 1
                    : 2 & button
                        ? 3
                        : 4 & button
    ...
    jQuery.Event = function (src, props) {
        ...
        src && src.type
            ? (this.originalEvent = src, this.type = src.type, this.isDefaultPrevented = src.defaultPrevented || void 0 === src.defaultPrevented && !1 === src.returnValue
                ? returnTrue
                : returnFalse)
            : this.type = src,
            ...
            jQuery
                ...
                .add(this, "beforeactivate._change", function (e) {
                    ...
                    rformElems.test(elem.nodeName) && !jQuery._data(elem, "changeBubbles") && (jQuery.event.add(elem, "change._change", function (event) {
                        !this.parentNode || event.isSimulated || event.isTrigger || jQuery
                            .event
                            .simulate("change", this.parentNode, event, !0)
    ...
    support.focusinBubbles || jQuery.each({
        ...
        var handler = function (event) {
            jQuery
                .event
                .simulate(fix, event.target, jQuery.event.fix(event), !0)
        };
        jQuery.event.special[fix] = {
            ...
            teardown: function () {
                ...
                attaches
                    ...
                    : (doc.removeEventListener(orig, handler, !0), jQuery._removeData(doc, fix))
            }
        }
    }),
    jQuery
        ...
        .extend({
            on: function (types, selector, data, fn, one) {
                ...
                if (null == data && null == fn
                    ...
                    : null == fn && ("string" == typeof selector
                        ? (fn = data, data = void 0)
                        : (fn = data, data = selector, selector = void 0)), !1 === fn) 
                    fn = returnFalse;
                else if (!fn) 
                    return this;
    ...
    jQuery.parseJSON = function (data) {
        ...
        return str && !jQuery.trim(str.replace(/(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g, function (token, comma, open, close) {
            ...
            0 === depth
                ? token
                : (requireNonComma = open || comma, depth += !close - !open, "")
        }))
            ? Function("return " + str)()
    ...
    jQuery.parseXML = function (data) {
        ...
        return xml && xml.documentElement && !xml
            .getElementsByTagName("parsererror")
            .length || jQuery.error("Invalid XML: " + data),
        xml
    };
    var ajaxLocParts,
        ajaxLocation,
    ...
    jQuery.extend({
        ...
        ajax: function (url, options) {
            function done(status, nativeStatusText, responses, headers) {
                ...
                2 !== state && (state = 2, timeoutTimer && clearTimeout(timeoutTimer), transport = void 0, responseHeadersString = headers || "", jqXHR.readyState = status > 0
                    ? 4
                    : 0, isSuccess = status >= 200 && status < 300 || 304 === status, responses && (response = ajaxHandleResponses(s, jqXHR, responses)), response = ajaxConvert(s, response, jqXHR, isSuccess), isSuccess
                    ? (s.ifModified && (modified = jqXHR.getResponseHeader("Last-Modified"), modified && (jQuery.lastModified[cacheURL] = modified), (modified = jqXHR.getResponseHeader("etag")) && (jQuery.etag[cacheURL] = modified)), 204 === status || "HEAD" === s.type
                        ? statusText = "nocontent"
                        : 304 === status
                            ? statusText = "notmodified"
                            : (statusText = response.state, success = response.data, error = response.error, isSuccess = !error))
                    : (error = statusText, !status && statusText || (statusText = "error", status < 0 && (status = 0))), jqXHR.status = status, jqXHR.statusText = (nativeStatusText || statusText) + "", isSuccess
                    ? deferred.resolveWith(callbackContext, [success, statusText, jqXHR])
                    : deferred.rejectWith(callbackContext, [jqXHR, statusText, error]), jqXHR.statusCode(statusCode), statusCode = void 0, fireGlobals && globalEventContext.trigger(isSuccess
                    ? "ajaxSuccess"
                    : "ajaxError", [
                    jqXHR, s, isSuccess
                        ? success
            ...
            if (deferred.promise(jqXHR).complete = completeDeferred.add, jqXHR.success = jqXHR.done, jqXHR.error = jqXHR.fail, s.url = ((url || s.url || ajaxLocation) + "").replace(/#.*$/, "").replace(/^\/\//, ajaxLocParts[1] + "//"), s.type = options.method || options.type || s.method || s.type, s.dataTypes = jQuery.trim(s.dataType || "*").toLowerCase().match(rnotwhite) || [""], null == s.crossDomain && (parts = rurl.exec(s.url.toLowerCase()), s.crossDomain = !(!parts || parts[1] === ajaxLocParts[1] && parts[2] === ajaxLocParts[2] && (parts[3] || ("http:" === parts[1]
                ? "80"
                : "443")) === (ajaxLocParts[3] || ("http:" === ajaxLocParts[1]
                ? "80"
                : "443")))), s.data && s.processData && "string" != typeof s.data && (s.data = jQuery.param(s.data, s.traditional)), inspectPrefiltersOrTransports(prefilters, s, options, jqXHR), 2 === state) 
                return jqXHR;
            fireGlobals = s.global,
            fireGlobals && 0 == jQuery.active ++&& jQuery
                .event
                .trigger("ajaxStart"),
            s.type = s
                .type
            ...
            cacheURL = s.url,
            s.hasContent || (s.data && (cacheURL = s.url += (rquery.test(cacheURL)
                ? "&"
                : "?") + s.data, delete s.data), !1 === s.cache && (s.url = rts.test(cacheURL)
    ...
    jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
        var callbackName,
            overwritten,
            responseContainer,
            jsonProp = !1 !== s.jsonp && (rjsonp.test(s.url)
                ? "url"
                : "string" == typeof s.data && !(s.contentType || "").indexOf("application/x-www-form-urlencoded") && rjsonp.test(s.data) && "data");
        if (jsonProp || "jsonp" === s.dataTypes[0]) 
            return callbackName = s.jsonpCallback = jQuery.isFunction(s.jsonpCallback)
                ? s.jsonpCallback()
                : s.jsonpCallback,
            jsonProp
                ? s[jsonProp] = s[jsonProp].replace(rjsonp, "$1" + callbackName)
                : !1 !== s.jsonp && (s.url += (rquery.test(s.url)
                    ? "&"
...
function (G) {
    function r(d, b, c) {
        var f,
            ...
            u = [],
            r = !1;
        if (c = c || {}, f = c.encoding || "UTF8", (v = c.numRounds || 1) !== parseInt(v, 10) || 1 > v) 
        ...
        this.setHMACKey = function (a, b, g) {
            ...
            if (f = (g || {}).encoding || "UTF8", b = A(b, f)(a),
            a = b.binLen,
            b = b.value,
            c = l >>> 3,
            g = c / 4 - 1,
            c < a / 8) {
                for (b = q(b, a, 0, x(d), e); b.length <= g;) 
                    b.push(0);
                b[g] &= 4294967040
            } else if (c > a / 8) {
                for (; b.length <= g;) 
        ...
        this.update = function (b) {
            var e,
                ...
                d = 0,
                q = l >>> 5;
            for (e = k(b, a, g), b = e.binLen, f = e.value, e = b >>> 5, c = 0; c < e; c += q) 
                d + l <= b && (m = p(f.slice(c, c + q), m), d += l);
            h += d,
            a = f.slice(d >>> 5),
            g = b % l,
            r = !0;
        ...
        this.getHash = function (b, f) {
            ...
            for (p = q(a.slice(), g, h, t(m), e), k = 1; k < v; k += 1) 
                p = q(p, e, 0, x(d), e);
            return c(p)
        },
    ...
    function D(d, b, c) {
        ...
        for (g = 0; g < a; g += 3) 
            for (f = g + 1 < a
                ...
                : 0, m = g + 2 < a
                ? d[g + 2 >>> 2]
                : 0, m = (d[g >>> 2] >>> 8 * (3 + g % 4 * -1) & 255) << 16 | (f >>> 8 * (3 + (g + 1) % 4 * -1) & 255) << 8 | m >>> 8 * (3 + (g + 2) % 4 * -1) & 255, f = 0; 4 > f; f += 1) 
                h += 8 * g + 6 * f <= b
                    ? "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(m >>> 6 * (3 - f) & 63)
                    : c.b64Pad;
        return h
    }
    function E(d, b) {
    ...
    function B(d) {
        ...
        if (d = d || {}, b.outputUpper = d.outputUpper || !1, !0 === d.hasOwnProperty("b64Pad") && (b.b64Pad = d.b64Pad), "boolean" != typeof b.outputUpper) 
        ...
        switch (d) {
            case "HEX":
                c = function (b, a, g) {
                    ...
                    for (a = a || [0], g = g || 0, p = g >>> 3, c = 0; c < f; c += 2) {
                        if (d = parseInt(b.substr(c, 2), 16), isNaN(d)) 
                            throw Error("String of HEX type contains invalid characters");
                        for (l = (c >>> 1) + p, e = l >>> 2; a.length <= e;) 
                            a.push(0);
                        a[e] |= d << 8 * (3 + l % 4 * -1)
                    }
                    return {
            ...
            case "TEXT":
                c = function (c, a, g) {
                    var f,
                        ...
                        n,
                        k = 0;
                    if (a = a || [0], g = g || 0, p = g >>> 3, "UTF8" === b) 
                        for (n = 3, e = 0; e < c.length; e += 1) 
                            for (f = c.charCodeAt(e), d = [], 128 > f
                                ? d.push(f)
                                : 2048 > f
                                    ? (d.push(192 | f >>> 6), d.push(128 | 63 & f))
                                    : 55296 > f || 57344 <= f
                                        ? d.push(224 | f >>> 12, 128 | f >>> 6 & 63, 128 | 63 & f)
                                        : (e += 1, f = 65536 + ((1023 & f) << 10 | 1023 & c.charCodeAt(e)), d.push(240 | f >>> 18, 128 | f >>> 12 & 63, 128 | f >>> 6 & 63, 128 | 63 & f)), l = 0; l < d.length; l += 1) {
                                for (t = k + p, q = t >>> 2; a.length <= q;) 
                                    a.push(0);
                                a[q] |= d[l] << 8 * (n + t % 4 * -1),
                                k += 1
                            }
                            ...
                            for (n = 2, e = 0; e < c.length; e += 1) {
                                for (f = c.charCodeAt(e), "UTF16LE" === b && (l = 255 & f, f = l << 8 | f >>> 8), t = k + p, q = t >>> 2; a.length <= q;) 
                                    a.push(0);
                                a[q] |= f << 8 * (n + t % 4 * -1),
                                k += 2
                            }
            ...
            case "B64":
                c = function (b, a, c) {
                    ...
                    if (k = b.indexOf("="), b = b.replace(/\=/g, ""), -1 !== k && k < b.length) 
                        throw Error("Invalid '=' found in base-64 string");
                    for (a = a || [0], c = c || 0, q = c >>> 3, k = 0; k < b.length; k += 4) {
                        for (p = b.substr(k, 4), e = l = 0; e < p.length; e += 1) 
                            d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(p[e]),
                            l |= d << 18 - 6 * e;
                        for (e = 0; e < p.length - 1; e += 1) {
                            for (n = f + q, d = n >>> 2; a.length <= d;) 
                                a.push(0);
            ...
            case "BYTES":
                c = function (b, a, c) {
                    var f,
                        ...
                        e,
                        l;
                    for (a = a || [0], c = c || 0, k = c >>> 3, d = 0; d < b.length; d += 1) 
                        f = b.charCodeAt(d),
                        l = d + k,
                        e = l >>> 2,
                        a.length <= e && a.push(0),
            ...
            case "ARRAYBUFFER":
                ...
                c = function (b, a, c) {
                    var d,
                        ...
                        k,
                        e;
                    for (a = a || [0], c = c || 0, m = c >>> 3, d = 0; d < b.byteLength; d += 1) 
                        e = d + m,
                        k = e >>> 2,
                        a.length <= k && a.push(0),
                        a[k] |= b[d] << 8 * (3 + e % 4 * -1);
    ...
    function z(d, b) {
        var h,
            ...
            e,
            c = [];
        for (h = b[0], a = b[1], g = b[2], f = b[3], m = b[4], e = 0; 80 > e; e += 1) 
            c[e] = 16 > e
                ? d[e]
                : n(c[e - 3] ^ c[e - 8] ^ c[e - 14] ^ c[e - 16], 1),
            k = 20 > e
                ? y(n(h, 5), a & g ^~ a & f, m, 1518500249, c[e])
                : 40 > e
                    ? y(n(h, 5), a ^ g ^ f, m, 1859775393, c[e])
                    : 60 > e
                        ? y(n(h, 5), a & g ^ a & f ^ g & f, m, 2400959708, c[e])
    ...
    function H(d, b, c, h) {
        var a;
        for (a = 15 + (b + 65 >>> 9 << 4); d.length <= a;) 
            d.push(0);
        for (d[b >>> 5] |= 128 << 24 - b % 32, b += c, d[a] = 4294967295 & b, d[a - 1] = b / 4294967296 | 0, b = d.length, a = 0; a < b; a += 16) 
    ...
    "function" == typeof define && define.amd
        ...
        : "undefined" != typeof exports
            ? ("undefined" != typeof module && module.exports && (module.exports = r), exports = r)
            : G.jsSHA = r
}(this),
function (global, factory) {
    ...
    function getSliceSHA1(opt) {
        var sha1Samples,
            ...
            file = opt.file,
            fileSize = file.size;
        opt.session && (sha1Samples = restoreSha1(opt.session));
        var pushPartAndCheck = function (part) {
            uploadParts.push(part);
            var sha1Index = part.offset + "-" + part.datalen;
            return !sha1Samples || !sha1Samples[sha1Index] || part.datasha === sha1Samples[sha1Index]
        };
        return reader.onload = function (e) {
            if ("cancel" !== opt.globalTask.state && file && !(file.length < 1)) {
                var middle = sha1Algo.update(this.content || this.result),
                    len = read + unit > fileSize
                        ? fileSize - read
                        : unit,
                    notEnd = read + len < fileSize,
                    sha1 = notEnd
                        ? middle
                        : sha1Algo.getHash("HEX");
                if (!pushPartAndCheck({offset: read, datalen: len, datasha: sha1})) 
                    return void defer.reject("sha1 not match");
                read += len,
    ...
    function sliceInit(opt) {
        ...
        $.ajax({
            ...
            success: function (res) {
                if ("cancel" !== opt.globalTask.state) 
                    if (res = res || {}, 0 == res.code) {
                        if (res.data.access_url) 
                            return void defer.resolve(res);
                        ...
                        for (var sItem, sha1Samples = {}, i = 1; i < opt.uploadparts.length; i *= 2) 
    ...
    function sliceUpload(opt) {
        ...
        for (i = 0; i < task.chunkCount; i++) {
                var start = i * opt.slice_size,
                    end = Math.min(start + opt.slice_size, file.size),
                    chunk = {
                        start: start,
                        end: end,
                        size: end - start
                ...
                partMap[start]
                    ? (task.loadedSize += chunk.size, chunk.state = "online")
                    : chunk.state = "waiting",
                task
                    .chunks
                    .push(chunk)
        ...
        var uploadSuccess = function () {
                task.onTaskProgress(!0),
                defer.resolve()
            },
            uploadError = function (error, res) {
        ...
        var uploadNextChunk = function () {
            if ("cancel" !== opt.globalTask.state) 
                for (; that._uploadingThreadCount < that.uploadMaxThread && task.currentIndex < task.chunkCount; task.currentIndex++) {
                    ...
                    "waiting" === chunk.state && function (chunk) {
                        ...
                        uploadSingleChunk.call(that, task, chunk, function (error, data) {
                            ...
                            that._uploadingThreadCount--,
                            error
                                ? (chunk.state = "error", uploadError(0, data))
                                : (chunk.state = "success", task.uploadingCount <= 0 && task.currentIndex >= task.chunkCount
                                    ? uploadSuccess()
                                    : uploadNextChunk())
                        })
                    }(chunk)
            ...
            : FileReader.prototype.readAsArrayBuffer
                ? readFun = function (fileData) {
                    ...
                    reader.onload = function (e) {
                        for (var bytes = new Uint8Array(reader.result), length = bytes.byteLength, i = 0; i < length; i++) 
    ...
    CosCloud.prototype.getAppSign = function (success, error, bucketName) {
        ...
        $.ajax({url: url, type: "GET", success: success, error: error})
    },
    ...
    CosCloud.prototype.deleteBase = function (success, error, bucketName, remotePath) {
        if ("/" == remotePath) 
            return void error({code: 10003, message: "不能删除Bucket"});
        var that = this;
    ...
    CosCloud.prototype.uploadFile = function (success, error, onprogress, bucketName, remotePath, file, insertOnly, taskReady) {
        var that = this;
        if (remotePath = fixPath(remotePath), file.size > 20971520) 
            return void that.sliceUploadFile(success, error, onprogress, bucketName, remotePath, file, insertOnly, void 0, void 0, taskReady);
        var $xhr,
            taskId = guid(),
            globalTask = {
                id: taskId,
        ...
        taskReady && "function" == typeof taskReady && taskReady(taskId),
        that.getAppSign(function (sign) {
            var url = that.getCgiUrl(remotePath, sign),
                formData = new FormData;
            ...
            $xhr = $.ajax({
                ...
                xhr: function () {
                    ...
                    return xhr.upload.onprogress = function (evt) {
                        ...
                        "function" == typeof onprogress && onprogress(percent, 0)
                    },
                    xhr
                },
                success: success,
    ...
    CosCloud.prototype.sliceUploadFile = function (success, error, onprogress, bucketName, remotePath, file, insertOnly, optSliceSize, bizAttr, taskReady) {
        ...
        that.getAppSign(function (sign) {
            ...
            "cancel" !== opt.globalTask.state && (optSliceSize = that.getSliceSize(optSliceSize), opt.bucket = bucketName, opt.path = remotePath, opt.file = file, opt.insertOnly = insertOnly, opt.sliceSize = optSliceSize || 1048576, opt.appid = that.appid, opt.sign = sign, opt.biz_attr = bizAttr || "", opt.onprogress = function (uploaded, sha1Check) {
                void 0 === sha1Check && (sha1Check = 1),
            ...
            sliceList.call(that, opt).always(function (res) {
                if ("cancel" !== opt.globalTask.state) {
                    ...
                    if (data && data.session) {
                        ...
                        if (opt.session = data.session, opt.listparts = listparts, listparts && listparts.length) {
                            var len = listparts.length;
                            opt.offset = listparts[len - 1].offset
                        }
                        data.sha && (opt.onlineSha = data.sha.split("_")[0]),
                        getSliceSHA1
                            .call(that, opt)
                            .done(function (uploadparts) {
                                if ("cancel" !== opt.globalTask.state) {
                                        ...
                                        .done(function () {
                                            sliceFinish
                                                ...
                                                .fail(function (d) {
                                                    error({
                                                        code: -1,
                                                        message: d && d.message || "slice finish error"
                                                    })
                                                })
                                        })
                                        .fail(function (d) {
                                            error({
                                                code: -1,
                                                message: d && d.message || "slice upload file error"
                                            })
                                        })
                                }
                            })
                            .fail(function (errMsg) {
                                error({
                                    code: -1,
                                    message: errMsg || "get slice sha1 error"
                                })
                            })
                    } else 
                        data && data.access_url
                            ? ("function" == typeof opt.onprogress && opt.onprogress(1, 0), success(res))
                            : getSliceSHA1
                                .call(that, opt)
                                .done(function (uploadparts) {
                                    if ("cancel" !== opt.globalTask.state) {
                                ...
                                .fail(function () {
                                    error({code: -1, message: "get slice sha1 error"})
                                })
                        }
            }))
        })
    ...
    CosCloud.prototype.cancelTask = function (taskId) {
        ...
        task && (task.state = "cancel", task.cancel())
    };
    var rememberSha1 = function (session, sha1Samples, sha1CacheExpired) {
            try {
                var data = JSON.parse(localStorage.getItem("_cos_sdk_sha1_")) || {}
            } catch (e) {}
            ...
            for (var i = localStorage.length - 1; i >= 0; i--) {
                ...
                current - localStorage
                    .getItem(key)
                    .update_time > sha1CacheExpired && localStorage.removeItem(key)
            }
            localStorage.setItem("_cos_sdk_sha1_", JSON.stringify(data))
        },
        restoreSha1 = function (session) {
            try {
                var data = JSON.parse(localStorage.getItem("_cos_sdk_sha1_")) || {}
            } catch (e) {}
            return data[session]
        },
        uploadSingleChunk = function (task, chunk, callback) {
            var that = this,
                formData = new FormData,
                opt = task.opt,
                file = opt.file,
                ...
                session = opt.session,
                totalSize = file.size,
                offsetStart = chunk.start,
                offsetEnd = Math.min(offsetStart + slice_size, totalSize),
                blob = that
                    .slice
                    .call(file, offsetStart, offsetEnd),
                chunkSize = blob.size,
                removeXhr = function (xhr) {
                    for (var i = task.uploadingAjax.length - 1; i >= 0; i--) 
                        xhr === task.uploadingAjax[i] && task.uploadingAjax.splice(i, 1)
                },
                preLoaded = 0,
                updateProgress = function (loaded, immediately) {
                    task.loadedSize += loaded - preLoaded,
                    preLoaded = loaded,
                    task.onTaskProgress && task.onTaskProgress(immediately)
                },
                uploadChunk = function (cb) {
                ...
                tryUpload = function (times) {
                    "cancel" !== opt.globalTask.state && uploadChunk(function (err, data) {
                        err
                            ? times >= that.uploadMaxRetryTimes || task.uploadError
                                ? callback(err, data)
                                : tryUpload(times + 1)
                            : callback(err, data)
                    })
...
function () {
    ...
    var videoTypes = [
        ...
        getFileMessage = function (file, newname) {
            var fileMsg = {};
            return fileMsg.type = file
                .name
                .slice(file.name.match(/\.[^\.]+$/).index + 1),
            fileMsg.name = newname || file
                .name
                .slice(0, file.name.match(/\.[^\.]+$/).index),
        ...
        startUpload = function (opts) {
            ...
            if (opts.videoFile) {
                if (opts.allowAudio && (AllowVideoTypes = videoTypes.concat(audioTypes)), "file" != getType(opts.videoFile)) 
            ...
            var timeouts;
            timeouts = 3 == opts.retryStartNum
                ? 3e3
                : 2 == opts.retryStartNum
                    ? 5e3
                    : 1e4;
            var fileMessage = {};
            return opts.videoFile && (fileMessage.videoMsg = getFileMessage(opts.videoFile, opts.videoName), fileMessage.videoMsg.error)
                ? fileMessage.videoMsg.error
                : opts.coverFile && (fileMessage.coverMsg = getFileMessage(opts.coverFile, opts.coverName), fileMessage.coverMsg.error)
                    ...
                    : void opts.getSignature(function (signature) {
                        ...
                        $.ajax({
                            ...
                            success: function (result, status, xhr) {
                                0 == result.code
                                    ? (opts.videoFile && setCookie(opts.videoFile.name, result.data.vodSessionKey, 24), uploadFile(opts, result, signature))
                                    : 10005 == result.code
        ...
        uploadFile = function (opts, result, signature) {
            ...
            if (result.data.cover) {
                ...
                result.data.video
                    ? cos2.uploadFile(successCallBack(opts, "cover"), errorCallBack(opts, "cover"), progressCallBack(opts, "cover"), result.data.storageBucket, result.data.cover.storagePath, opts.coverFile, 1)
        ...
        finishUpload = function (opts, result, signature) {
            ...
            var timeouts;
            timeouts = 3 == opts.retryFinishNum
                ? 3e3
                : 2 == opts.retryFinishNum
                    ? 5e3
                    : 1e4,
            $.ajax({
...
}();/*  |xGv00|b39b512469cf0a53ca13f835b95e45b9 */