...
export default class CustomerArbitration extends Base {
  static get NAME() {
    return "CustomerArbitration";
  }
  ...
  constructor(props, context) {
    super(props, context);
    if (context.data[CustomerArbitration.NAME]) {
  ...
  handleGoback = () => {
    ...
    this.showModal("customerBackModal", {
      customerIds,
      customerNames
    });
  };
    ...
    return (
      <Page {...this.props}>
        <Breadcrumb className="page-breadcrumb">
          ...
          <Breadcrumb.Item>客户仲裁</Breadcrumb.Item>
        </Breadcrumb>
